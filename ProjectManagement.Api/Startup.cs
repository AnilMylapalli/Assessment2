...
namespace ProjectManagement.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            IServiceCollection serviceCollection = services.AddDbContext<PMContext>(options => options.UseOracle(connectionString));
        ...
        private IServiceCollection RegisterDependencies(IServiceCollection services)
        {
            ...
            services.AddTransient<ICartItemDataService, CartItemDataService>();
